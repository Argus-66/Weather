...
form.addEventListener("submit", (e) => {
  /*if the input fill is empty, throw and alert */

  if (search.value.length == 0) {
    alert("Please type in a city name");
  } else {
    /*change from default city*/
...
function fetchWeatherData() {
  ...
  //your own key
  fetch(
    `https://api.weatherapi.com/v1/current.json?key=21e5a88a4ad944febd1234112240602&q=${cityInput}&aqi=yes`
  )
    ...
    .then((data) => {
      ...
      /*Date and Time from the city and extract the day, month, year and time into individual variables */
